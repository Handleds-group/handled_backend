        ...
        <div class=\"card shadow-xl\" style=\"background:{SUCCESS_CARD}; border:1px solid {SUCCESS_BORDER};\">
          <div class=\"card-body gap-6\">
            ...
            <div class=\"rounded-xl p-4\" style=\"background:#F7F3FF; border:1px dashed #D8C6F7;\">
              ...
              <p class=\"mt-1\" style=\"color:{SUCCESS_MUTED};\">Your payment is confirmed. You can return to the app and enjoy premium features instantly.</p>
            </div>

            <div class=\"flex justify-center\">
              <a class=\"btn\" style=\"background:#{EMAIL_THEME_COLOR}; border-color:#{EMAIL_THEME_COLOR}; color:#FFFFFF;\" href=\"{LANDING_PAGE_URL}\">Open Handled</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class=\"card shadow-xl\" style=\"background:{CANCEL_CARD}; border:1px solid {CANCEL_BORDER};\">
          <div class=\"card-body gap-6\">
            ...
            <div class=\"flex flex-col sm:flex-row gap-3\">
              <a class=\"btn\" style=\"background:#DC2626; border-color:#DC2626; color:#FFFFFF;\" href=\"{LANDING_PAGE_URL}\">Back to Handled</a>
              <a class=\"btn btn-ghost\" style=\"color:{CANCEL_TEXT};\" href=\"{LANDING_PAGE_URL}\">Try Checkout Again</a>
            </div>
          </div>
        </div>
      </div>
